...
# Define the path to machines.xlsx
excel_path = resource_path("machines.xlsx")
...
try:
    ...
    messagebox.showerror("Error", f"No se pudo cargar el archivo Excel:\n{str(e)}\n\n"
                                  "Posible causa: El archivo 'machines.xlsx' no está en el mismo directorio que el script.\n"
                                  "Solución:\n"
                                  "1. Asegúrate de que el archivo 'machines.xlsx' esté en la misma carpeta que el script.\n"
                                  "2. Verifica que el archivo Excel no esté dañado o que el nombre sea correcto.\n")
    exit()
